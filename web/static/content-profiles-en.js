(function () {
  // Localized profile bridge: keeps the EN content layer complete when full editorial modules are loaded separately from UI labels.
  const lang = "en";
  ...
  const sectionTitles = {
    image: "Snapshot",
    logic: "Inner logic",
    thinking: "How this type thinks",
    decisions: "How decisions are made",
    work: "Work and study",
    communication: "Communication",
    motivation: "What motivates this type",
    drain: "What drains this type",
    strengths: "Strengths",
    difficulties: "Possible difficulties",
    stress: "Under stress",
    growth: "What helps this type grow",
    advice: "Practical anchors",
